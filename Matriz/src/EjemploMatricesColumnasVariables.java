public class EjemploMatricesColumnasVariables {
    public static void main(String[] args) {
        ...
        //Declaramos que en la matriz fila [0] contendra [2] columnas
        matriz[0] = new int[2];
        //Declaramos que en la matriz fila [1] contendra [3] columnas
        matriz[1] = new int[3];
        //Declaramos que en la matriz fila [2] contendra [4] columnas
        matriz[2] = new int[4];
